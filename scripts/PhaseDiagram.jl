...
input_dir  = "/Users/chardiol/Desktop/Theory of Brain/FNS-Julia/JudesFNSWorkshop/data/exp_raw/phasedata/k=0.2/g=0.1"
output_dir = "/Users/chardiol/Desktop/Theory of Brain/FNS-Julia/JudesFNSWorkshop/data/exp_pro/phasedata/k=0.2/g=0.1"
...
for file in ProgressBar(csv_files)
    ...
    # println([aval,bval,meanx,meany])
    # println("x:$(meanx), y:$(meany), alph:(aval),bet:$(bval)")
end
